...
const Button = () => {
  return (
    <>
      <button className="relative shadow-lg shadow-red-7 00 hover:border-sky-600 duration-500 group cursor-pointer text-slate-900 font-jet-mono text-md hover:text-lg overflow-hidden h-14 w-52 rounded-3xl bg-orange-800 p-2 flex justify-center items-center font-extrabold">
